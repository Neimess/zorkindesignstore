...
func (_mock *MockAttributeRepository) Update(ctx context.Context, attr1 *attr.Attribute) error {
	ret := _mock.Called(ctx, attr1)
...
func (_c *MockAttributeRepository_Update_Call) Return(err error) *MockAttributeRepository_Update_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockAttributeRepository_Update_Call) RunAndReturn(run func(ctx context.Context, attr1 *attr.Attribute) error) *MockAttributeRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
